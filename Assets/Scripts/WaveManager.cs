...
public class WaveManager : MonoBehaviour
{
    ...
    private bool allSpawned = false; // ← flag: semua enemy wave ini sudah di-spawn
    ...
    void SpawnEnemy(GameObject enemyPrefab)
    {
        ...
        // Register enemy ke GameManager saat di-spawn
    ...
    {
            GameObject enemy = Instantiate(bossEnemy, spawnPoints[1].position, Quaternion.identity);
            GameManager.Instance.RegisterEnemy();
            yield return new WaitForSeconds(1f);
